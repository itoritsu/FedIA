...
from backbone.gnn.ssp import SSP
from backbone.gnn.sage import SAGE_Net
class FederatedDataset:
    ...
    def get_gnn_backbone_dict(self):
        nets_dict = {'gcn':GCN_Net,'gat':GAT_Net,"gpr":GPR_Net,'pmlp_gcn':PMLP_GCN,'pmlp_sgc':PMLP_SGC,'pmlp_appnp':PMLP_APPNP,'gdg':GDG,'ssp':SSP, 'sage': SAGE_Net}
        return nets_dict
